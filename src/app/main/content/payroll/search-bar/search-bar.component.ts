...
const CUSTOM_INPUT_VALIDATORS: any = {
    ...
    useExisting: forwardRef(() => PayrollSearchBarComponent),
    multi: true
};
...
@Component({
    selector: 'app-payroll-search-bar',
...
export class PayrollSearchBarComponent implements ControlValueAccessor, OnInit, OnChanges {
