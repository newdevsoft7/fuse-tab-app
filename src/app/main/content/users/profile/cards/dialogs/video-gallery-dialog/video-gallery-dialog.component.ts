...
@Component({
    selector: 'app-profile-cards-video-gallery-dialog',
    templateUrl: './video-gallery-dialog.component.html',
    styleUrls: ['./video-gallery-dialog.component.scss'],
    encapsulation: ViewEncapsulation.None
})
export class ProfileCardsVideoGalleryDialogComponent implements OnInit {
    ...
    ngOnInit() {
        ...
        this.index = this.videos.findIndex(v => v.thumb == this.video.thumb);
    }
