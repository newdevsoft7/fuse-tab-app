...
@Component({
    selector: 'app-profile-cards-photo-gallery-dialog',
    templateUrl: './photo-gallery-dialog.component.html',
    styleUrls: ['./photo-gallery-dialog.component.scss'],
    encapsulation: ViewEncapsulation.None
})
export class ProfileCardsPhotoGalleryDialogComponent implements OnInit {
    ...
    ngOnInit() {
        ...
        this.index = this.photos.findIndex(v => v.thumb == this.photo.thumb);
    }
