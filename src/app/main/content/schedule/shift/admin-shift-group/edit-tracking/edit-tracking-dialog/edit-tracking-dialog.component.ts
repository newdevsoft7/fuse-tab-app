...
@Component({
    selector: 'app-group-edit-tracking-dialog',
    templateUrl: './edit-tracking-dialog.component.html',
    styleUrls: ['./edit-tracking-dialog.component.scss'],
    encapsulation: ViewEncapsulation.None
})
export class GroupEditTrackingDialogComponent implements OnInit {
    ...
    constructor(
        public dialogRef: MatDialogRef<GroupEditTrackingDialogComponent>,
