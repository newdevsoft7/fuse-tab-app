...
export const TAB = {
   // Admin tabs
    ...
    'SCHEDULE_IMPORT_SHIFTS_IMPORT_HISTORY_TAB': new Tab('Import History', '', 'schedule/import-shifts/import-history', {}),
    'SCHEDULE_IMPORT_SHIFTS_COLUMN_MAPPING_TAB': new Tab('Column Mapping', '', 'schedule/import-shifts/column-mapping', {}),
    ...
    'SETTINGS_PROFILE_DOCUMENT_CATEGORIES_TAB': new Tab('Document Categories', '', 'settings/profile/document-categories', {}),
    ...
    'SETTINGS_PROFILE_PHOTO_CATEGORIES_TAB': new Tab('Photo Categories', '', 'settings/profile/photo-categories', {}),
