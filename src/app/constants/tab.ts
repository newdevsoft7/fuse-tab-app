...
export const TAB = {
   // Admin tabs
    ...
    'USERS_CARDS': new Tab('Cards', 'cardsTpl', 'users/cards', {}),
    'USERS_PRESENTATIONS_TAB': new Tab('Presentations', 'presentationsTpl', 'users/presentations', {}),
    ...
    'QUIZS_TAB': new Tab('Quizzes', 'quizsTpl', 'quizs', {}),
